...
{
    public static string luaDir = Application.dataPath + "/Scripts/Runtime/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/Scripts/Runtime/Lua/ToLua/Lua";        //tolua lua文件目录
