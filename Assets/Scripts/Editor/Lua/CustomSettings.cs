...
using Multiverse.Runtime;

public static class CustomSettings
{
    public static string saveDir = Application.dataPath + "/Scripts/Runtime/Lua/Source/Generate/";
    public static string toluaBaseType = Application.dataPath + "/Scripts/Runtime/Lua/ToLua/BaseType/";
    ...
    {                
        ...
        _GT(typeof (List<int>)),
        _GT(typeof (List<Vector2>)),
        _GT(typeof (List<string>)),
        _GT(typeof (List<double>)),
        _GT(typeof (List<bool>)),
